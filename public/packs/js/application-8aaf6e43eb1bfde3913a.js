...
var mealsByCategory = {
  Feature: ["Soup", "Juice", "Tea", "Others"],
  Bug: ["Soup", "Juice", "Water", "Others"]
};
...
function changeStatus(value) {
  ...
  console.log("value");
  console.log(value);
  if (value.length == 0) document.getElementById("status").innerHTML = "<option></option>";else {
    var catOptions = "";
    ...
    document.getElementById("status").innerHTML = catOptions;
  }
}
...
/******/ });
//# sourceMappingURL=application-8aaf6e43eb1bfde3913a.js.map